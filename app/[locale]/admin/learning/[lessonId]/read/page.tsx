...
export default async function ReadLessonPage({ params }: PageProps) {
	...
	return (
		<div className="space-y-6">
			...
			<LearningPageActions
				...
				updateHref={`/${locale}/admin/learning/${lesson.id}/update`}
				deleteHref={`/${locale}/admin/learning/${lesson.id}/delete`}
				deleteLabel={lesson.title}
			/>
		</div>
	)
}
