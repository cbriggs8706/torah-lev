...
import VerseRevealGame from './english-verse-revelator'
import VerseVanisher from './english-verse-vanisher'
import VerseFillInTheBlank from './english-verse-fill'
...
export default function MemorizeModeMenu({ verses, onBack }: Props) {
