	...
	return (
		<div className="relative w-12 h-14 flex items-center justify-center">
			<svg viewBox="0 0 36 36" className="absolute inset-0 w-full h-full">
				...
				{/* TODO change this scale to accomodate more digits */}
				<g transform="translate(-4, -6) scale(1.25)">
					<path
			...
			<span
				className="relative text-lg font-bold translate-y-[10px]"
				style={{ color: text }}
			>
				{lessonNumber ?? '-'}
			</span>
