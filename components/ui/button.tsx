	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide',
	{
		variants: {
			variant: {
				...
				primary:
					'bg-primary text-primary-foreground hover:bg-primary/90 border-primary/80 border-b-4 active:border-b-0',
				primaryOutline: 'bg-white text-primary hover:bg-accent',
				secondary:
					'bg-primary/90 text-primary-foreground hover:bg-primary border-primary border-b-4 active:border-b-0',
				secondaryOutline: 'bg-white text-primary hover:bg-accent',
				danger:
				...
				sidebarOutline:
					'bg-sidebar-primary/15 text-sidebar-primary border-sidebar-primary/30 border-2 hover:bg-sidebar-primary/20 transition-none',
			},
			size: {
