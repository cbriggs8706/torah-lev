...
type Props = { data: PresentConjugationTable | null; title: string }

export default function HebrewVerbPresentCard({ data, title }: Props) {
	if (!data || !data.rows?.length) return null

	// Function to render each conjugation row
	const renderCell = (row?: PresentConjugationRow) =>
		row ? (
	...
	return (
		<div className="bg-green-50 rounded-xl shadow-xl p-4 mb-6 border-4 border-green-600">
